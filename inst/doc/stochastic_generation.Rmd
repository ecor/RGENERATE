...
- Calibration of the stochastic generations, i.e. creation of a *GPCAvarest2* object instance for the model whose parameterts like order of autocorrelations and number of GPCA iterations are inserted as function arguments;
